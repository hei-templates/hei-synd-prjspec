# Contributing to hei-synd-prjspec

Thanks for your interest in improving the **HEI Typst Project Specification Template**! ❤️
...
1. Check the [README](https://github.com/hei-templates/hei-synd-prjspec/blob/main/README.md) and example files.
2. Search [existing issues](https://github.com/hei-templates/hei-synd-prjspec/issues).
3. If none fit, open a new [issue](https://github.com/hei-templates/hei-synd-prjspec/issues/new) with:
...
Please open an [issue](https://github.com/hei-templates/hei-synd-prjspec/issues/new) and include:
