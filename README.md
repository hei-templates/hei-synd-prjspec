![GitHub Repo stars](https://img.shields.io/github/stars/hei-templates/hei-synd-prjspec)
![GitHub Release](https://img.shields.io/github/v/release/hei-templates/hei-synd-prjspec)
![](https://tianji.zahno.dev/telemetry/clnzoxcy10001vy2ohi4obbi0/cmmor7zs705b8opa36h0eadnd.gif)
...
1. In the `Typst` Univers select the `hei-synd-prjspec` template. Locally you can use the Typst CLI to initialise the project:

   ```bash
   # from the typst universe
   typst init @preview/hei-synd-prjspec:0.1.0
   ```
...
All notable information about contributing to this project can be found in the [CONTRIBUTING.md](https://github.com/hei-templates/hei-synd-prjspec/blob/main/CONTRIBUTING.md) file.
...
All notable changes to this project are documented in the [CHANGELOG.md](https://github.com/hei-templates/hei-synd-prjspec/blob/main/CHANGELOG.md) file.
